...
public:
	int nthElement(vector <int> lowerBound, vector <int> upperBound, int n)
	{
		...
		forn(i, lowerBound.size())
			bounds.pb(Pair(lowerBound[i], upperBound[i]));

//		tr(it, bounds)
//			cout << it->lo << " " << it->hi << endl;
//		cout << endl;

		int64 lo = -2000000000, hi = 2000000000, mid, idx;
